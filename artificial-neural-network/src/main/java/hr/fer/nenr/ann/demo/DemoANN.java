...
public class DemoANN {
    public static void main(String[] args) {
        ...
        ann.train(List.of(new Example(List.of(new Point(1, 0.1)), List.of(1.0, 0.0)),
                new Example(List.of(new Point(0.1, 1)), List.of(0.0, 1.0))), 1);
        System.out.println(ann.predict(List.of(new Example(List.of(new Point(1, 0.1)), List.of()))));
        System.out.println(ann.predict(List.of(new Example(List.of(new Point(0.1, 1)), List.of()))));
    }
}
